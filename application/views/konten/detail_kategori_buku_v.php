  <script>
    function select_data($IDBUKU, $IDRAK, $ISBNCODE, $JUDUL, $PENGARANG, $PENERBIT, $JML_HALAMAN, $TGL_TERBIT, $BAHASA, $PANJANG, $LEBAR, $BERAT, $JML_STOCK, $JML_STOCK_DISEWA, $DESKRIPSI, $SINOPSIS){
      $("#idbuku2").val($IDBUKU);
      $("#idrak2").val($IDRAK);
      $("#isbncode2").val($ISBNCODE);
      $("#judul2").val($JUDUL);
      $("#pengarang2").val($PENGARANG);
      $("#penerbit2").val($PENERBIT);
      $("#jml_halaman2").val($JML_HALAMAN);
      $("#tgl_terbit2").val($TGL_TERBIT);
      $("#bahasa2").val($BAHASA);
      $("#panjang2").val($PANJANG);
      $("#lebar2").val($LEBAR);
      $("#berat2").val($BERAT);
      $("#jml_stock2").val($JML_STOCK);
      $("#jml_stock_disewa2").val($JML_STOCK_DISEWA);
      $("#deskripsi2").val($DESKRIPSI);
      $("#sinopsis2").val($SINOPSIS);
    }
    function refresh(){
      $("#idbuku2").val("");
      $("#idrak2").val("");
            ...
            <div class="modal-body">
              <div class="col-md-12">
                <div class="form-horizontal text-left">
                  <div class="box-body">
                  <div class="form-group">
                  <input type="hidden" name="idbuku" id="idbuku2" class="form-control" value="" placeholder="Masukkan idbuku" required>
                  <input type="hidden" name="idrak" id="idrak2" class="form-control" value="" placeholder="Masukkan idrak" required>
                      <label class="col-sm-2 control-label" for="">ISBNCODE </label>
                      <div class="col-sm-10">
                        <input type="text" name="isbncode" id="isbncode2" class="form-control" value="" placeholder="Masukkan isbncode" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="">JUDUL </label>
                      <div class="col-sm-10">
                        <input type="text" name="judul" id="judul2" class="form-control" value="" placeholder="Masukkan judul" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="">PENGARANG </label>
                      <div class="col-sm-10">
                        <input type="text" name="pengarang" id="pengarang2" class="form-control" value="" placeholder="Masukkan pengarang" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="">PENERBIT </label>
                      <div class="col-sm-10">
                        <input type="text" name="penerbit" id="penerbit2" class="form-control" value="" placeholder="Masukkan penerbit" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="">JML_HALAMAN </label>
                      <div class="col-sm-10">
                        <input type="text" name="jml_halaman" id="jml_halaman2" class="form-control" value="" placeholder="Masukkan jml_halaman" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="">TGL_TERBIT </label>
                      <div class="col-sm-10">
                        <input type="text" name="tgl_terbit" id="tgl_terbit2" class="form-control" value="" placeholder="Masukkan tgl_terbit" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="">BAHASA </label>
                      <div class="col-sm-10">
                        <input type="text" name="bahasa" id="bahasa2" class="form-control" value="" placeholder="Masukkan bahasa" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="">PANJANG </label>
                      <div class="col-sm-10">
                        <input type="text" name="panjang" id="panjang2" class="form-control" value="" placeholder="Masukkan panjang" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="">LEBAR </label>
                      <div class="col-sm-10">
                        <input type="text" name="lebar" id="lebar2" class="form-control" value="" placeholder="Masukkan lebar" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="">BERAT </label>
                      <div class="col-sm-10">
                        <input type="text" name="berat" id="berat2" class="form-control" value="" placeholder="Masukkan berat" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="">JML_STOCK </label>
                      <div class="col-sm-10">
                        <input type="text" name="jml_stock" id="jml_stock2" class="form-control" value="" placeholder="Masukkan jml_stock" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="">JML_STOCK_DISEWA </label>
                      <div class="col-sm-10">
                        <input type="text" name="jml_stock_disewa" id="jml_stock_disewa2" class="form-control" value="" placeholder="Masukkan jml_stock_disewa" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="">DESKRIPSI </label>
                      <div class="col-sm-10">
                        <input type="text" name="deskripsi" id="deskripsi2" class="form-control" value="" placeholder="Masukkan deskripsi" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="">SINOPSIS </label>
                      <div class="col-sm-10">
                        <input type="text" name="sinopsis" id="sinopsis2" class="form-control" value="" placeholder="Masukkan sinopsis" required>
                      </div>
                    </div>
                  </div>
                </div>
